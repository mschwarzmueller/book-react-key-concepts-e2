...
// Dummy todos, managed in memory on the server
// For production, you would, of course, store them in a file or database
const TODOS = [];

// API endpoint to get all todos (GET /api/todos)
app.get('/api/todos', (req, res) => {
  res.json(TODOS);
});

// API endpoint to add a new todo (POST /api/todos)
